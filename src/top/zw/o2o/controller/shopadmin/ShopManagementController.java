    ...
    private Map<String,Object> getShopManagementInfo(HttpServletRequest request){
        ...
        if(shopId <= 0){
            ...
            if(currentShopObj == null){
                ...
                modelMap.put("url","SchoolMarket1/shopadmin/shoplist");
            }else{
...
//    private static void inputStreanToFile(InputStream ins, File file){
...
//                }
//            }catch (IOException e){
//                throw new RuntimeException("调用inputStreamToFile关闭异常" + e.getMessage());
//            }
//        }
//    }
